# Code taken from: https://www.kaggle.com/code/jorgesandoval/easymetrics

# Author: Jorge Sandoval
# Date: January, 2021
# Purpose: Implement a package full of statistical functions
# Versions:
## 1.0
## Diebold-Mariano Test:
### This Python function dm_test implements the Diebold-Mariano Test (1995)
### with modification suggested by Harvey et. al (1997) to statistically identify forecast accuracy
### equivalance for 2 sets of predictions.
## R2, MAE, EVS, RMSE, RMSLE:
### Created a function for each of of this metrics, that returns train, test and valid values.
