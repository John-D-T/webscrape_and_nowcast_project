...
if __name__ == '__main__':
    ...
    parser.add_argument(name_or_flags='--N', type=int, default=5000, help='Number of reviews to scrape')
    parser.add_argument(name_or_flags='--i', type=str, default='', help='target URLs file') # need to refactor default to list of cinemas scraped
    parser.add_argument(name_or_flags='--sort_by', type=str, default='newest', help='most_relevant, newest, highest_rating or lowest_rating')
